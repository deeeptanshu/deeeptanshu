...
- **Hiring tools** — interactive dashboards and calculators for HR teams
...
Infra         Vercel · GitHub Actions · Apify · Slack API · n8n
...
| [Competitive Intel Hub](https://github.com/deeeptanshu/competitive-intel-hub) | Hourly competitor monitoring: news + pricing diffs + hiring signals → Claude classification → Slack alerts + Salesforce updates. SQLite dedup, weekly digests. |
| [TechSparks GTM Automation](https://github.com/deeeptanshu/techsparks-gtm-automation) | Event-to-outreach pipeline for 162 real attendees: rule-based enrichment → seniority routing → Claude persona gen → personalised email sequences. One-command runner. |
| [Dormant Lead Reactivation](https://github.com/deeeptanshu/dormant-lead-reactivation) | 3-stage AI pipeline: Serper news fetch → Signal Triager (urgency score) → IF gate → Context Synthesizer → Email Writer. n8n workflow + Python runner. |
